...
<body>
    ...
    <!-- Morris Chart Js -->
    <script src="/style/users/assets/js/morris/raphael-2.1.0.min.js"></script>
    <script src="/style/users/assets/js/morris/morris.js"></script>
	
	
	<script src="/style/users/assets/js/easypiechart.js"></script>
	<script src="/style/users/assets/js/easypiechart-data.js"></script>
