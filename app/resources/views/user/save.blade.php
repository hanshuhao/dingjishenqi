        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a href="save" class="active-menu"><i class="fa fa-edit"></i> 修改个人信息 </a>
                    </li>
                                ...
                                <div class="col-lg-6">
                                    <form role="form" method="post" action="info" enctype="multipart/form-data">
                                        <div class="form-group">
                                            <label>真实姓名</label>
                                            <input class="form-control" name="uname" placeholder="请填写您的真实姓名">
                                        </div>
                                        <div class="form-group">
                                            <label>省份证</label>
                                            <input name="IDcard" class="form-control" placeholder="必须为国家二代省份证">
                                        </div>
                                        <div class="form-group">
                                            <label>邮箱</label>
                                            <input name="email" class="form-control" placeholder="常用邮箱">
                                        </div>
                                        <div class="form-group">
                                            <label>上传头像</label>
