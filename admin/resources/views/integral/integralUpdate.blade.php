						...
						<ul class="accordion">
							...
							<li class="bg-palette1 active">
								<a href="index.html">
									<span class="menu-content block">
										...
										<span class="text m-left-sm">定机神器</span>
									</span>
							...
							<li class="bg-palette2">
								<a href="landing/landing.html">
									<span class="menu-content block">
										...
										<span class="text m-left-sm">不知名的跳转</span>
									</span>
									<span class="menu-content-hover block">
										不知名的跳转
									</span>
							...
							<li class="bg-palette1">
								<a href="users_show">
									<span class="menu-content block">
										...
										<span class="text m-left-sm">用户中心</span>
									</span>
									<span class="menu-content-hover block">
										用户中心
									</span>
							...
							<li class="bg-palette2">
								<a href="internet_bar">
									<span class="menu-content block">
										...
										<span class="text m-left-sm">网吧中心</span>
									</span>
									<span class="menu-content-hover block">
										网吧中心
									</span>
							...
							<li class="bg-palette3">
								<a href="invoice">
									<span class="menu-content block">
										<span class="menu-icon"><i class="block fa fa-clock-o fa-lg"></i></span>
										<span class="text m-left-sm">发票查看</span>
									</span>
									<span class="menu-content-hover block">
										发票查看
									</span>
